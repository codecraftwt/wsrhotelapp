...
const AdvanceReportScreen = () => {
  ...
  const onRefresh = () => {
    setRefreshing(true);
    dispatch(fetchAdvanceReports()).finally(() => setRefreshing(false));
  };
  ...
  return (
    <SafeAreaView style={[styles.container, { paddingBottom: insets.bottom }]}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Advance Reports</Text>
...
const styles = StyleSheet.create({
  ...
  cardList: {
    paddingHorizontal: 8,
    paddingVertical: 20, // ensure last card is visible
  },
  card: {
    backgroundColor: '#fff',
    borderRadius: 16,
